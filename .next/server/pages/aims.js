(()=>{var e={};e.id=86,e.ids=[86],e.modules={4350:e=>{e.exports={content:"WordpressText_content__Bmxbe",prose:"WordpressText_prose__xawnJ","prose-xl":"WordpressText_prose-xl__rHQ_x"}},1041:(e,t,s)=>{"use strict";s.a(e,async(e,r)=>{try{s.r(t),s.d(t,{config:()=>f,default:()=>c,getServerSideProps:()=>m,getStaticPaths:()=>p,getStaticProps:()=>g,reportWebVitals:()=>x,routeModule:()=>b,unstable_getServerProps:()=>h,unstable_getServerSideProps:()=>v,unstable_getStaticParams:()=>S,unstable_getStaticPaths:()=>P,unstable_getStaticProps:()=>y});var a=s(7093),n=s(5244),o=s(1323),i=s(7645),d=s(6814),u=s(9030),l=e([u]);u=(l.then?(await l)():l)[0];let c=(0,o.l)(u,"default"),g=(0,o.l)(u,"getStaticProps"),p=(0,o.l)(u,"getStaticPaths"),m=(0,o.l)(u,"getServerSideProps"),f=(0,o.l)(u,"config"),x=(0,o.l)(u,"reportWebVitals"),y=(0,o.l)(u,"unstable_getStaticProps"),P=(0,o.l)(u,"unstable_getStaticPaths"),S=(0,o.l)(u,"unstable_getStaticParams"),h=(0,o.l)(u,"unstable_getServerProps"),v=(0,o.l)(u,"unstable_getServerSideProps"),b=new a.PagesRouteModule({definition:{kind:n.x.PAGES,page:"/aims",pathname:"/aims",bundlePath:"",filename:""},components:{App:d.default,Document:i.default},userland:u});r()}catch(e){r(e)}})},8484:(e,t,s)=>{"use strict";s.d(t,{CP:()=>c,DT:()=>o,Y8:()=>g,_S:()=>l,ds:()=>i,h9:()=>n,iX:()=>d,vx:()=>u});let r=process.env.WORDPRESS_API_URL;async function a(e="",{variables:t}={}){let s=await fetch(r,{headers:{"Content-Type":"application/json"},method:"POST",body:JSON.stringify({query:e,variables:t})}),a=await s.json();if(a.errors)throw console.error(a.errors),Error("Failed to fetch API");return a.data}async function n(){let e=await a(`
    {
      posts(first: 10000) {
        edges {
          node {
