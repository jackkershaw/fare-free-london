...
`);return e?.categories?.edges||[]}async function u(){let e=await a(`
  ...
  `);return e?.posts}},418:(e,t,s)=>{s.a(e,async(e,r)=>{try{s.r(t),s.d(t,{default:()=>c,getStaticProps:()=>g});var a=s(997),n=s(6689),o=s(6836),i=s(8484),l=s(7393),d=e([o]);function c({allPosts:{edges:e},Categories:t}){let[s,r]=(0,n.useState)(null),i=s?e.filter(({node:e})=>e.categories.nodes.some(e=>e.name===s)):e;return a.jsx("div",{children:a.jsx(o.Z,{children:a.jsx("div",{className:"lg:grid lg:grid-cols-3 lg:gap-x-5 lg:gap-y-5",children:i.map(({node:e})=>a.jsx(l.Z,{title:e.title,coverImage:e.featuredImage,slug:e.slug,excerpt:e.excerpt,category:e.categories.nodes.map(e=>e.name)},e.slug))})})})}o=(d.then?(await d)():d)[0];let g=async({})=>{let e=await (0,i.DT)({preview:!1}),t=await (0,i.CP)();return{props:{allPosts:e,Categories:t},revalidate:10}};r()}catch(e){r(e)}})},2785:e=>{e.exports=require("next/dist/compiled/next-server/pages.runtime.prod.js")},968:e=>{e.exports=require("next/head")},6689:e=>{e.exports=require("react")},6405:e=>{e.exports=require("react-dom")},997:e=>{e.exports=require("react/jsx-runtime")},9752:e=>{e.exports=import("@vercel/analytics/react")},7451:e=>{e.exports=import("@vercel/speed-insights/next")},6197:e=>{e.exports=import("framer-motion")},1017:e=>{e.exports=require("path")}};var t=require("../webpack-runtime.js");t.C(e);var s=e=>t(t.s=e),r=t.X(0,[859,391,673],()=>s(4613));module.exports=r})();